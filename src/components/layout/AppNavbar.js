...
class AppNavbar extends Component {
    render() {
        return (
          ...
          <Link className="navbar-brand" to={process.env.PUBLIC_URL + "/"}>HMS Harmony</Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mr-auto">
              ...
              <li>
                <Link className="nav-link" to={process.env.PUBLIC_URL + "/fanfiction-list"}>Fanfiction</Link>
              </li>
              <li>
